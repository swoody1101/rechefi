...
def down_sample(input_wav, origin_sr, resample_sr, file_name):
    ...
    sf.write('./' + f'{file_name}' + '_mono_reduc_16k.wav', resample, resample_sr, format='WAV', endian='LITTLE', subtype='PCM_16')

# man_original_data = 'C:/Users/multicampus/Desktop/SSAFY7기/특화PJT/인공지능/STT/pre-trained/KoreanSTT-DeepSpeech2-main/earphone5.wav'
