...
class Article(Model):
    ...
    recipe = fields.ForeignKeyField('b303.Recipe', related_name='articles', through='article_recipe', db_constraint=False, description='해당 게시물에 참조된 레시피', null=True)
...
class Cooking(Model):
    ...
    views = fields.IntField(default=0)
    recipe = fields.ForeignKeyField('b303.Recipe', related_name='cookings', through='cooking_recipe', db_constraint=False, description='해당 게시물에 참조된 레시피', null=True)
